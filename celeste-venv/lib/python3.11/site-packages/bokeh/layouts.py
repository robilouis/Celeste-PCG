...
@overload
def row(
    *children: UIElement, sizing_mode: SizingModeType | None = None, **kwargs: Any
) -> Row: ...


def row(
    *children: UIElement | list[UIElement],
    sizing_mode: SizingModeType | None = None,
    **kwargs: Any,
) -> Row:
    ...
    for y, row in enumerate(children):
        for x, item in enumerate(row):
            if item is None:
                ...
                raise ValueError(
                    "Only UIElement and LayoutDOM items can be inserted into a grid"
                )
...
@overload
def grid(
    children: list[UIElement | list[UIElement | list[Any]]],
    *,
    sizing_mode: SizingModeType | None = ...,
) -> GridBox: ...
@overload
def grid(
    children: Row | Column, *, sizing_mode: SizingModeType | None = ...
) -> GridBox: ...
@overload
def grid(
...
def _handle_child_sizing(
    children: list[UIElement], sizing_mode: SizingModeType | None, *, widget: str
) -> None:
...
def _create_grid(
    iterable: Iterable[UIElement | list[UIElement]],
    sizing_mode: SizingModeType | None,
    layer: int = 0,
    **kwargs,
) -> Row | Column:
