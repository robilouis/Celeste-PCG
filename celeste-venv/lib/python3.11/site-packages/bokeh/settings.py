...
def convert_logging(value: str | int) -> PyLogLevel:
    ...
    * "none"
    ...
    raise ValueError(
        f"Cannot convert {value} to log level, valid values are: {', '.join(_log_levels)}"
    )
...
def convert_validation(value: str | ValidationLevel) -> ValidationLevel:
    ...
    raise ValueError(
        f"Cannot convert {value!r} to validation level, valid values are: {VALID_LEVELS!r}"
    )
...
class Settings:
    ...
    chromedriver_path: PrioritizedSetting[str | None] = PrioritizedSetting(
        "chromedriver_path",
    ...
    default_server_host: PrioritizedSetting[str] = PrioritizedSetting(
        "default_server_host",
    ...
    default_server_port: PrioritizedSetting[int] = PrioritizedSetting(
        "default_server_port",
