...
class ScalarHatchProps(HasProps):
    ...
    hatch_pattern = Nullable(
        String, help=_hatch_pattern_help
...
class LineProps(HasProps):
    ...
    line_dash_offset = IntSpec(
        default=0,
        help="""The distance into the ``line_dash`` (in pixels) that the pattern should start from.""",
    )
...
class ScalarTextProps(HasProps):
    ...
    text_outline_color = Nullable(
        Color, default=None, help=_color_help % "outline text"
    )
