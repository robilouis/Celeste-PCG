...
class Property(PropertyDescriptorFactory[T]):
    ...
    assertions: list[
        tuple[Callable[[HasProps, T], bool], str | Callable[[HasProps, str, T], None]]
    ]

    def __init__(
        self, *, default: Init[T] = Intrinsic, help: str | None = None
    ) -> None:
    ...
    def accepts(
        self, tp: TypeOrInst[Property[Any]], converter: Callable[[Any], T]
    ) -> Property[T]:
    ...
    def asserts(
        self,
        fn: Callable[[HasProps, T], bool],
        msg_or_fn: str | Callable[[HasProps, str, T], None],
    ) -> Property[T]:
...
class ParameterizedProperty(Property[T]):
    ...
    def __init__(
        self,
        *type_params: TypeOrInst[Property[T]],
        default: Init[T] = Intrinsic,
        help: str | None = None,
    ) -> None:
        _type_params = [self._validate_type_param(param) for param in type_params]
        default = (
            default if default is not Intrinsic else _type_params[0]._raw_default()
        )
    ...
    @staticmethod
    def _validate_type_param(
        type_param: TypeOrInst[Property[Any]], *, help_allowed: bool = False
    ) -> Property[Any]:
...
class SingleParameterizedProperty(ParameterizedProperty[T]):
    ...
    def __init__(
        self,
        type_param: TypeOrInst[Property[Any]],
        *,
        default: Init[T] = Intrinsic,
        help: str | None = None,
    ):
