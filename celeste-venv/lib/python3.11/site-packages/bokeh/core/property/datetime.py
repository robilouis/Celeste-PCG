...
class Datetime(Property[Union[str, datetime.date, datetime.datetime]]):
    ...
    def __init__(
        self,
        default: Init[str | datetime.date | datetime.datetime] = Undefined,
        *,
        help: str | None = None,
    ) -> None:
    ...
    def validate(self, value: Any, detail: bool = True) -> None:
        ...
        msg = (
            ""
            if not detail
            else f"Expected a date, datetime object, or timestamp, got {value!r}"
        )
        raise ValueError(msg)

    @staticmethod
    def is_timestamp(value: Any) -> bool:
        return isinstance(value, (float, *bokeh_integer_types)) and not isinstance(
            value, bool
        )
...
class Time(Property[Union[str, datetime.time]]):
    ...
    def __init__(
        self, default: Init[str | datetime.time] = Undefined, *, help: str | None = None
    ) -> None:
        super().__init__(default=default, help=help)
    ...
    def validate(self, value: Any, detail: bool = True) -> None:
        ...
        msg = (
            ""
            if not detail
            else f"Expected a time object, or ISO formatted time string, got {value!r}"
        )
        raise ValueError(msg)
...
class TimeDelta(Property[datetime.timedelta]):
    ...
    def __init__(
        self,
        default: Init[datetime.timedelta] = datetime.timedelta(),
        *,
        help: str | None = None,
    ) -> None:
        super().__init__(default=default, help=help)
