...
class Enum(String):
    ...
    @overload
    def __init__(
        self, enum: str, *values: str, default: Init[str] = ..., help: str | None = ...
    ) -> None: ...

    def __init__(
        self,
        enum: str | enums.Enumeration,
        *values: str,
        default: Init[str] = Intrinsic,
        help: str | None = None,
    ) -> None:
    ...
    def validate(self, value: Any, detail: bool = True) -> None:
        ...
        msg = (
            ""
            if not detail
            else f"invalid value: {value!r}; allowed values are {nice_join(self.allowed_values)}"
        )
