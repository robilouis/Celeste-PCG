...
FactorSeqType: TypeAlias = tp.Union[
    tp.Sequence[str], tp.Sequence[tuple[str, str]], tp.Sequence[tuple[str, str]]
]
...
class Factor(SingleParameterizedProperty[FactorType]):
    ...
    def __init__(
        self, default: Init[FactorType] = Intrinsic, *, help: str | None = None
    ) -> None:
...
class FactorSeq(SingleParameterizedProperty[FactorSeqType]):
    ...
    def __init__(
        self, default: Init[FactorSeqType] = Intrinsic, *, help: str | None = None
    ) -> None:
