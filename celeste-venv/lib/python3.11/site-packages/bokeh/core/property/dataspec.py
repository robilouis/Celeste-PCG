...
class DataSpec(Either):
    ...
    def __init__(self, value_type, default, *, help: str | None = None) -> None:
        ...
        self.accepts(
            Instance("bokeh.models.expressions.Expression"), lambda obj: Expr(obj)
        )
...
class AlphaSpec(NumberSpec):
    ...
    def __init__(self, default=1.0, *, help: str | None = None) -> None:
        help = f"{help or ''}\n{ALPHA_DEFAULT_HELP}"
        super().__init__(
            default=default, help=help, accept_datetime=False, accept_timedelta=False
        )
...
class UnitsSpec(NumberSpec):
    ...
    def __init__(
        self, default, units_enum, units_default, *, help: str | None = None
    ) -> None:
...
class AngleSpec(UnitsSpec):
    ...
    def __init__(
        self, default=Undefined, units_default="rad", *, help: str | None = None
    ) -> None:
        super().__init__(
            default=default,
            units_enum=enums.AngleUnits,
...
class DistanceSpec(UnitsSpec):
    ...
    def __init__(
        self, default=Undefined, units_default="data", *, help: str | None = None
    ) -> None:
        super().__init__(
            default=default,
            units_enum=enums.SpatialUnits,
            units_default=units_default,
            help=help,
        )
...
class NullDistanceSpec(DistanceSpec):
    ...
    def __init__(
        self, default=None, units_default="data", *, help: str | None = None
    ) -> None:
