...
class AliasPropertyDescriptor(Generic[T]):
    ...
    def __init__(self, name: str, alias: Alias[T]) -> None:
        ...
        self.property = alias
        self.__doc__ = (
            f"This is a compatibility alias for the {self.aliased_name!r} property."
        )
...
class PropertyDescriptor(Generic[T]):
    ...
    def _get_default(self, obj: HasProps) -> T:
        ...
        unstable_dict = (
            obj._unstable_themed_values if is_themed else obj._unstable_default_values
        )
    ...
    def _notify_mutated(
        self, obj: HasProps, old: Any, hint: DocumentPatchedEvent | None = None
    ) -> None:
...
class ColumnDataPropertyDescriptor(PropertyDescriptor):
    ...
    def __set__(self, obj, value, *, setter=None):
        ...
        hint = (
            ColumnDataChangedEvent(obj.document, obj, "data", setter=setter)
            if obj.document
            else None
        )
