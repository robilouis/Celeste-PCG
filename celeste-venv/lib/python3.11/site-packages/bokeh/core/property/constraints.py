...
class TypeOfAttr(SingleParameterizedProperty[T]):
    ...
    def __str__(self) -> str:
        ...
        return (
            f"{class_name}({self.type_param}, {self._query_name!r}, {self._query_type})"
        )
    ...
    def validate(self, value: Any, detail: bool = True) -> None:
        ...
        try:
            ...
            raise ValueError(
                f"expected {value!r} to have an attribute '{name}'" if detail else ""
            )
        ...
        raise ValueError(
            f"expected {value!r} to have an attribute {name!r} of type {type}"
            if detail
            else ""
        )
