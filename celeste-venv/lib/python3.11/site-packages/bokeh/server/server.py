...
class BaseServer:
    ...
    * a Tornado ``HTTPServer`` to direct HTTP requests
    ...
    def __init__(
        self, io_loop: IOLoop, tornado_app: BokehTornado, http_server: HTTPServer
    ) -> None:
    ...
    def show(
        self, app_path: str, browser: str | None = None, new: BrowserTarget = "tab"
    ) -> None:
    ...
    def port(self) -> int | None:
        ...
        sock = next(
            sock
            for sock in self._http._sockets.values()
    ...
    * a Tornado ``HTTPServer`` to direct HTTP requests
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if opts.unix_socket:
            ...
            if opts.allow_websocket_origin:
                extra_websocket_origins = create_hosts_allowlist(
                    opts.allow_websocket_origin, None
                )
            else:
        ...
        self._absolute_url = server_url(
            self._address, self._port, opts.ssl_certfile is not None
        )
