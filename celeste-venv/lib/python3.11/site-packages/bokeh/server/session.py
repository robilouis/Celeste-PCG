...
class ServerSession:
    ...
    def __init__(
        ...
        wrapped_callbacks = [
            self._wrap_session_callback(cb) for cb in self._document.session_callbacks
        ]
    ...
    @_needs_document_lock
    def _handle_pull(
        self, message: msg.pull_doc_req, connection: ServerConnection
    ) -> msg.pull_doc_reply:
    ...
    @classmethod
    def pull(
        cls, message: msg.pull_doc_req, connection: ServerConnection
    ) -> msg.pull_doc_reply:
    ...
    @_needs_document_lock
    def _handle_push(
        self, message: msg.push_doc, connection: ServerConnection
    ) -> msg.ok:
    ...
    @_needs_document_lock
    def _handle_patch(
        self, message: msg.patch_doc, connection: ServerConnection
    ) -> msg.ok:
