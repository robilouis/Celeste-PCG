...
class Axis(GuideRenderer):
    ...
    face = Either(Auto, Enum("front", "back"))(
        default="auto",
        help="""
    ...
    axis_label_orientation = Either(Enum(LabelOrientation), Float)(
        default="parallel",
        help="""
    ...
    major_label_orientation = Either(Enum(LabelOrientation), Float)(
        default="horizontal",
        help="""
