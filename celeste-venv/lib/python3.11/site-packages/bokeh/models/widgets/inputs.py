...
class Select(InputWidget):
    ...
    """,
        ...
        List(Either(Null, String)),
        lambda v: ["" if item is None else item for item in v],
    )
...
class ColorMap(InputWidget):
    ...
    items = Required(
        Seq(Tuple(String, Seq(Color))),
        help="""
    """,
    )

    swatch_width = NonNegative(
        Int,
        default=100,
        help="""
    """,
