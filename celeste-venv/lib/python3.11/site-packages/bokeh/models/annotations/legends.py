...
class ScaleBar(Annotation):
    ...
    dimensional = Instance(
        Dimensional,
        default=InstanceDefault(MetricLength),
        help="""
    ...
    * ``"exact"`` - the computed length is used as-is
    ...
    bar_length = NonNegative(Either(Float, Int))(
        default=0.2,
        help="""
    ...
    * ``@{unit}`` The unit of measure, by default in the short form.
    ...
    ticker = Instance(
        Ticker,
        default=InstanceDefault(FixedTicker, ticks=[]),
        help="""
    A ticker to use for computing locations of axis components.
