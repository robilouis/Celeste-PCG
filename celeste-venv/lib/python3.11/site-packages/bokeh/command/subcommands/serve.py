...
class Serve(Subcommand):
    ...
    def customize_applications(
        self, args: argparse.Namespace, applications: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def customize_kwargs(
        self, args: argparse.Namespace, server_kwargs: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def invoke(self, args: argparse.Namespace) -> None:
        ...
        if "unix_socket" in server_kwargs:
            ...
            if any(server_kwargs.get(x) for x in invalid_args):
                die(
                    f"{[*invalid_args, 'port']} args are not supported with a unix socket"
                )
