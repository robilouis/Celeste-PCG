...
class DocumentModuleManager:
    ...
    def add(self, module: ModuleType) -> None:
        ...
        if module.__name__ in sys.modules:
            raise RuntimeError(
                f"Add called already-added module {module.__name__!r} for {self._document()!r}"
            )
    ...
    def destroy(self) -> None:
        ...
        log.debug(
            f"Deleting {len(self._modules)} modules for document {self._document()!r}"
        )
        ...
        for module in self._modules:
            ...
            referrers = [
                x for x in referrers if x is not sys.modules
            ]  # lgtm [py/comparison-using-is]
            referrers = [
                x for x in referrers if x is not self._modules
            ]  # lgtm [py/comparison-using-is]
