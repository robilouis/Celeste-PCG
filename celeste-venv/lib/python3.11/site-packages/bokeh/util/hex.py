...
def axial_to_cartesian(
    q: Any, r: Any, size: float, orientation: str, aspect_scale: float = 1
) -> tuple[Any, Any]:
...
def cartesian_to_axial(
    x: Any, y: Any, size: float, orientation: str, aspect_scale: float = 1
) -> tuple[Any, Any]:
...
def hexbin(
    x: Any, y: Any, size: float, orientation: str = "pointytop", aspect_scale: float = 1
) -> Any:
