...
InvokeResult: TypeAlias = Union[
    Awaitable[None], Awaitable[list[Any]], Awaitable[dict[Any, Any]]
]
...
class _CallbackGroup:
    ...
    def _assign_remover(
        self, callback: Callback, callback_id: ID, removers: Removers, remover: Remover
    ) -> None:
    ...
    def add_timeout_callback(
        self, callback: CallbackSync, timeout_milliseconds: int, callback_id: ID
    ) -> ID:
    ...
    def add_periodic_callback(
        self, callback: Callback, period_milliseconds: int, callback_id: ID
    ) -> None:
