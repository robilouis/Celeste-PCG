...
def collect_filtered_models(
    discard: Callable[[Model], bool] | None, *input_values: Any
) -> list[Model]:
...
def visit_immediate_value_references(
    value: Any, visitor: Callable[[Model], None]
) -> None:
...
def visit_value_and_its_immediate_references(
    obj: Any, visitor: Callable[[Model], None]
) -> None:
