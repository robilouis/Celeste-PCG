...
def autoload_static(
    model: Model | Document, resources: Resources, script_path: str
) -> tuple[str, str]:
...
def components(
    models: Model,
    wrap_script: bool = ...,  # type: ignore[overload-overlap] # XXX: mypy bug
...
def json_item(
    model: Model, target: ID | None = None, theme: ThemeLike = None
) -> StandaloneEmbedJson:
...
def _check_models_or_docs(
    models: ModelLike | ModelLikeCollection,
) -> ModelLikeCollection:
    """ """
