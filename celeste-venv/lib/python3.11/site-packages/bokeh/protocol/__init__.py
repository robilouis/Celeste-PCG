...
class Protocol:
    ...
    @overload
    def create(
        self, msgtype: Literal["ERROR"], request_id: ID, text: str, **metadata: Any
    ) -> error: ...
    @overload
    ...
    def create(
        self,
        msgtype: Literal["PULL-DOC-REPLY"],
        request_id: ID,
        document: Document,
        **metadata: Any,
    ) -> pull_doc_reply: ...
    @overload
    def create(
        self, msgtype: Literal["PULL-DOC-REQ"], **metadata: Any
    ) -> pull_doc_req: ...
    @overload
    def create(
        self, msgtype: Literal["PUSH-DOC"], document: Document, **metadata: Any
    ) -> push_doc: ...
    @overload
    def create(
        self, msgtype: Literal["SERVER-INFO-REPLY"], request_id: ID, **metadata: Any
    ) -> server_info_reply: ...
    @overload
    def create(
        self, msgtype: Literal["SERVER-INFO-REQ"], **metadata: Any
    ) -> server_info_req: ...
    ...
    def assemble(
        self, header_json: str, metadata_json: str, content_json: str
    ) -> Message[Any]:
