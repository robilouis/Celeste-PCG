...
def main():
    ...
    if "--use-c-switch" in sys.argv:
        child_process = subprocess.Popen(
            [
                ...
                "-u",
                "-c",
                "import _debugger_case_pydevd_customization;_debugger_case_pydevd_customization.call()",
            ],
        ...
        os.waitpid(pid, 0)
        child_process = (
            None  # We don't really have a subprocess.Popen instance in this case.
        )
    else:
        child_process = subprocess.Popen(
            [
    ...
    if child_process:
        ...
        assert (
            b"called" in stdout
        ), 'Did not find b"called" in stdout:\n>>%s<<\nstderr:\n>>%s<<\n' % (
            stdout,
            stderr,
        )
