...
def update_room_array(array, x, y, d_proba_estimation, bt_depth=0, verbose=True):
    ...
    if bt_depth_true:
        ...
        while k >= 0 and k < bt_depth_true:
            try:
                pb_dist = extract_proba_from_tile(array_temp, x, y+k, d_pe=d_proba_estimation)
        ...
        array[x+2, y+2] = generate_new_tile(extract_proba_from_tile(array, x, y, d_pe=d_proba_estimation))
